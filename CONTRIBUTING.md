...
2. Create a new topic branch from `main` (e.g., `feature/vector-search-filter` or `fix/pdf-encoding`).
...
2. Add unit tests for new features or bug fixes under the `tests/` directory.
